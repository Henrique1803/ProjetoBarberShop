...
public class Banco {
    ...
    public static ArrayList<Agendamento> agendamento = new ArrayList<Agendamento>();
    ...
    public static void inicia(){
        ...
        if(contador ==0){
            ...
            Usuario usuario2 = new Usuario(2, "estagiario", 'M', "09/05/1996", "30212122", "estagiario@barbershop.com", "451244123", "estagiario", "funcionário");
            ...
            Agendamento agendamento1 = new Agendamento(1, cliente1, servico2, 30, "14/03/2024 09:30");
            Agendamento agendamento2 = new Agendamento(2, cliente3, servico4, 40, "14/03/2024 10:00");
            Agendamento agendamento3 = new Agendamento(3, cliente4, servico1, 18, "14/03/2024 10:30");
